#!/usr/bin/env bats
# T-009..T-012: plan-gate の readiness チェックと fail-closed な parse。
...
# fixture は fixtures/plans にあるので、contract test も build.js コピーを非 object エントリの
# 同じ placeholder-id 表記 (units[i]) にロックする。
