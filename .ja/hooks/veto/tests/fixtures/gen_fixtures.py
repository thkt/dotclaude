...
write("bash-verdict-go.json", {
    ...
    "tool_name": "Bash",
    "tool_input": {"command": f'python3 hooks/veto/veto.py verdict-gate --title "{TITLE}"'},
    "tool_response": {
        "stdout": dumps({
            "verdict": "GO",
            "downgraded": False,
...
write("bash-plan-ready.json", {
    "hook_event_name": "PostToolUse",
    "tool_name": "Bash",
    "tool_input": {"command": f'python3 hooks/veto/veto.py plan-gate --title "{TITLE}"'},
    "tool_response": {
...
write("bash-research-done.json", {
    ...
    "tool_response": {
        "stdout": dumps({"done": True, "file": RESEARCH_FILE, "normalized_title": TITLE}),
        "stderr": "",
        "interrupted": False,
    },
    "duration_ms": 110,
