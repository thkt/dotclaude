...
description: >
  ...
  プログレッシブエンハンスメントとCSS-firstアプローチの知識は[@~/.claude/skills/enhancing-progressively/SKILL.md]を参照。
...
**ナレッジベース**: [@~/.claude/skills/enhancing-progressively/SKILL.md](~/.claude/skills/enhancing-progressively/SKILL.md)
