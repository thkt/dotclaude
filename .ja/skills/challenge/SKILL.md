...
| セクション       | 内容                                                                      |
| ---------------- | ------------------------------------------------------------------------- |
| Verdict          | 検証対象が問題なら 本物 / 偽 / 条件付き、アイデアなら 使える / 使えない / 要改訂。1 行で先頭に |
