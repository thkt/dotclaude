...
1. units / tests / 前提 / test_command を `${CLAUDE_SKILL_DIR}/references/plan-section.md` の書式で `## Plan` 節に写す。contract は生成でなく選択で書く (引用 + やりたいこと。規則は plan-section.md § contract の authoring 規則)
