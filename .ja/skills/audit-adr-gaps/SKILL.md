...
| 7    | レポートを `docs/audit/<YYYY-MM-DD>-<HHMMSS>-undocumented-decisions.md` に出力              |
...
- レポートパス: `docs/audit/<YYYY-MM-DD>-<HHMMSS>-undocumented-decisions.md`
...
- [ ] `docs/audit/<YYYY-MM-DD>-<HHMMSS>-undocumented-decisions.md` が存在
