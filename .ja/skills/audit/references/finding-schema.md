...
- 具体 trigger と reasoning の両方が書ける (Language Constraints を参照)
...
## Domain-Specific Extensions (統合時に正規化)
...
例: "Unused import in 7 files" → 1 finding、severity は最悪ケースから
...
| Error        | アクション                                       |
| ------------ | ------------------------------------------------ |
| Glob 空      | 0 ファイル発見と報告; clean と推論しない         |
