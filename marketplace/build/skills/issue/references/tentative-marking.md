...
- A first pass, not a verification pass; settling facts is delegated to the premise check
...
| Fact not yet verified (residual the premise check could not settle)                               | tentative | `(tentative: ...)` | "recheck at pickup"                                   |
