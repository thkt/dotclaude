...
| Table use         | Are enumerations of 3+ items sharing the same attribute pair written as a table, not bullets? The Plan section stays bullets per the extraction contract |
...
| Dense paragraph    | One paragraph or bullet packing decision + rationale + references into 3+ sentences with nested parentheticals   | Split into one claim per sentence; move enumerations to bullets / a table, promote parenthetical rationale to its own sentence |
| Long sentence      | Claims chained with connectives, one sentence exceeding ~25 words (Japanese: 60 characters)                      | Cut at each claim; give conditions and rationale their own sentence                                                            |
