...
For detailed guidelines on reviewing bilingual documentation, see:
[@../../rules/guidelines/JP_EN_TRANSLATION_RULES.md](../../rules/guidelines/JP_EN_TRANSLATION_RULES.md)

**Key points**:

- Files under `.ja/` are Japanese translations (structure-only review)
- DO NOT compare EN content with JP content
- Check structure/links match, not translated text
