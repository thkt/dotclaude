...
| Skill frontmatter    | name, description (per SKILL_FORMAT.md)               | `skills/*/SKILL.md`              |
...
| Conflicting instructions across files       | SKIP          | Cross-file is duplication-reviewer's scope |
