...
| 13  | grep/ugrep alternation | grep BRE uses `\|` for alternation; ugrep ERE default uses `|` (`\|` is literal). On 0 hits, suspect syntax mismatch                 | Verify alternation behavior with a known symbol            |
