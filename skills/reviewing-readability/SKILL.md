...
description: >
  ...
  ミラーの法則, 認知負荷, AI-generated, 過剰設計. Do NOT use for
  security issues (reviewing-security), type errors (reviewing-type-safety),
  error handling (reviewing-silent-failures), or test design
