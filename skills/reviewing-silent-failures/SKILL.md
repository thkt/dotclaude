...
description: >
  ...
  empty catch, エラーハンドリング, 握りつぶし, swallowed error. Do NOT
  use for security vulnerabilities (reviewing-security), readability
  (reviewing-readability), or type safety (reviewing-type-safety).
