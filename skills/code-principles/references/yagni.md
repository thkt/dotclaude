...
- [@./occams-razor.md](./occams-razor.md) - Choose the simplest solution
- [@../development/PROGRESSIVE_ENHANCEMENT.md](../../rules/development/PROGRESSIVE_ENHANCEMENT.md) - Build minimal, enhance progressively

### Decision Making

**YAGNI Question**: "Do we need this now?"
**Occam's Razor Question**: "What's the simplest way?"
**Progressive Enhancement**: "Can we start simpler?"

Answer all three, build the minimum.
