...
description: Feature development orchestration with team exploration, architecture, and TDD.
user-invocable: false
---

# Feature Orchestration

Phase details for /feature command workflow.
...
- [Resume](references/resume.md) — SOW discovery, state tracking
