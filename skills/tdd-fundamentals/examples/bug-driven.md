...
[@~/.claude/commands/shared/test-generation.md#pattern-2-bug-driven-generation](~/.claude/commands/shared/test-generation.md#pattern-2-bug-driven-generation)
...
- ❌ Trivial fix with high confidence
- ❌ Comprehensive tests already exist
- ❌ Non-testable changes (pure UI)
