...
- [@~/.claude/agents/reviewers/sow-spec.md] - sow-spec reviewer agent
- [@~/.claude/commands/think.md] - /think command
- [@~/.claude/skills/reviewing-readability/SKILL.md] - readability review skill
