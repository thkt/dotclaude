...
Do not proceed to Step 1 until the Why Statement is clear. If any field is
vague or assumed, use back-and-forth dialogue — not placeholders.
...
The goal is to draw out what the user already knows but has not yet
articulated.
