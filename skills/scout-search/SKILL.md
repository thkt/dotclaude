---
name: scout-search
description: "Web search, page fetch, and GitHub repo exploration via scout CLI. Use when: web search, page fetch, deep research, GitHub repo exploration, latest docs, release notes, library docs, external info, WebFetch alternative, WebSearch alternative, 最新ドキュメント, リリースノート, 外部情報."
...
| scout-search                       | Built-in WebFetch / WebSearch      |
| ---------------------------------- | ---------------------------------- |
