...
```bash
~/.claude/skills/docs-domain/scripts/extract-entities.sh {path}
```
...
```bash
~/.claude/skills/docs-domain/scripts/extract-glossary.sh {path}
```
...
```bash
~/.claude/skills/docs-domain/scripts/generate-er-diagram.sh {path}
```
