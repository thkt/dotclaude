...
// with no Python caller left: the proofreading hook retired on main and the auto-fix hook
// retires here, so japanese.py and its test are residue a later slice removes.
//
