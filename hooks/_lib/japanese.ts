...
// because hooks/pre-bash/body_proofread.py, hooks/_lib/mirror_prose.py, and hooks/edit/
// textlint_fix.py (via mirror_prose) still import it, so both live side by side until every
// caller moves over.
//
