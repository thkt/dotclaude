...
// hooks/_lib/, next to scribe_trigger.py/.ts, rather than skills/scribe/scripts/; the retired
...
// scribe_trigger.py's _unmerged_scribe_pr_exists / _last_scribe_merge / _has_new_input, not a
// decision this file makes on its own. scribe_trigger.ts is not part of this unit (out of scope
...
// should_run got by importing scribe_trigger, not a reimplementation of scribe_trigger.py's own
