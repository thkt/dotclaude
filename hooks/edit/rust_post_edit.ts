...
// edit itself broke. TypeScript port of hooks/edit/rust_post_edit.py (unit U-003,
// docs/decisions/0112-adopt-typescript-for-helper-scripts.md): composes hooks/_lib/
// rust_target.ts's target/fmt/clippyOutput, the same shared module rust_pre_edit.ts composes.
