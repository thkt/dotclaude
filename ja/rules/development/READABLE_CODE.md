...
→ 可読性のあるコードの背後にある認知科学については [@~/.claude/ja/skills/applying-code-principles/SKILL.md](~/.claude/ja/skills/applying-code-principles/SKILL.md) を参照
...
// Good: 手続き的アプローチ：一度きりのタスクにはよりシンプル
