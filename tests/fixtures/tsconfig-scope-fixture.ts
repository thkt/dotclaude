...
// tests/ reaches the type-check set. Committed rather than written per run: the sandbox denies
// writes under tests/, so creating it at test time fails with EPERM (the same reason
