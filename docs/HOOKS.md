...
| Kind        | Shape                 | Example                     |
| ----------- | --------------------- | --------------------------- |
| Python hook | `<target>_<op>.py`    | `rumdl_check.py`      |
| shell hook  | `<target>-<op>.sh`    | `failure-alert.sh`          |
| _lib module | `<noun>.py`           | `command_scan.py`           |
| Python test | `<hook name>_test.py` | `rumdl_check_test.py` |
...
| gh_filing.ts    | issue_body_gate                                                 |
| hook_payload.py | scribe_prompt, amphetamine, rust_target, and the edit hooks      |
| hook_payload.ts | mirror_prose, rust_target, recall_index, and the edit hooks     |
| mirror_prose.ts | mirror_prose_guard and the .ja/ sweep test                      |
| japanese.py     | textlint_fix                                                    |
| japanese.ts     | mirror_prose                                                    |
| textlint.py     | textlint_fix                                                    |
