...
## 11. IDR Configuration

| Key          | Value        | Rationale                    |
| ------------ | ------------ | ---------------------------- |
| idr_required | [true/false] | [reason based on complexity] |

### Auto-determination Criteria

IDR is **required** when ANY of:

- SOW exists (traceability needed)
- Files to modify ≥ 3 (complex change)
- Architectural decisions involved
- New patterns introduced

IDR is **skipped** when ALL of:

- No SOW (ad-hoc task)
- Files to modify ≤ 2 (simple change)
- No architectural decisions
- Following existing patterns only
