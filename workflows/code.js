...
for (const [index, unit] of units.entries()) {
  ...
  const ctx =
    ...
    referenceModuleCtx +
    `Check the conditions and status of Plan-cited wiki/DRs and originals against the current work. Update documents only within this unit’s files, preserving accepted DR bodies. If a needed document update is outside the Plan, do not edit it: record its path, reason, and return to /think and /issue in notes. Matching versions alone do not establish adoption.\n` +
